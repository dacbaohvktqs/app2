...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IVTQKL47dvwa/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9Qwav, {
          [sty.freeBoxcolor_neutral___9QwavX0FL8]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered___9QwavanbaaUUg03]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull___9Qwav6H6OX]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge___9Qwav8Ort]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall___9Qwav9BHx]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large___9QwavoEfFw]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small___9Qwav0GsWh]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered___9QwavuUg03]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_soft___9QwavfubQa]: hasVariant(
            $state,
            "type",
            "soft"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__fzStR, {
            [sty.freeBoxcolor_neutral__fzStRx0FL8]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__fzStRx0FL8FubQa]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__fzStR3MXXm]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__fzStR8Ort]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__fzStRoEfFw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__fzStR0GsWh]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__fzStRuUg03]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___744Hs)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__cAF, {
            [sty.freeBoxiconEnd__cAFzV4Lm]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__cAF8Ort]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__cAFoEfFw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__cAF0GsWh]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___3Ezkb)}
                role={"img"}
              />
            ),
