...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: 8uBjm1cQnZBk/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___92MwS)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__kyf39)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__iloGb)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__rCBwQ)}>
          <div className={classNames(projectcss.all, sty.freeBox__grXxk)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__eLvu7)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__wd9Xr)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__yfQhK)}
          />
        </div>
      </Stack__>
    </div>
